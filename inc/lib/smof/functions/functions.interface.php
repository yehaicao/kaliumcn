...
function optionsframework_add_admin() {
    ...
    $of_page = add_theme_page( THEMENAME, '主题设置', 'edit_theme_options', 'theme-options', 'optionsframework_options_page');
...
function of_style_only(){
	...
	wp_enqueue_style('laborator-style', ADMIN_DIR . 'assets/css/laborator-smof.css');
