...
<form name="checkout" method="post" class="checkout woocommerce-checkout row" action="<?php echo esc_url( $get_checkout_url ); ?>" enctype="multipart/form-data">
	...
	<?php if ( sizeof( $checkout->checkout_fields ) > 0 ) : ?>
		...
		<div class="<?php echo get_option( 'woocommerce_ship_to_destination' ) != 'billing_only' ? apply_filters( 'kalium_shop_checkout_columns_class', 'col2-set ' ) : ''; ?>col-md-7" id="customer_details">
			<div class="col-1">
	...
	<?php # start: modified by Arlind ?>
	<div class="col-md-<?php echo sizeof( $checkout->checkout_fields ) > 0 ? 5 : 12; ?>">
