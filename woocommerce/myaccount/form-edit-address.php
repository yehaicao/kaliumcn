...
<?php else : ?>
	...
	<form method="post">
		...
		<div class="section-title">
			...
			<p><?php _e( 'Edit information for this address type', 'kalium' ); ?></p>
		</div>
		...
		<p>
			<?php # start: modified by Arlind ?>
			<input type="submit" class="button btn btn-primary shop-btn" name="save_address" value="<?php _e( 'Save Address', 'woocommerce' ); ?>" />
			<?php # end: modified by Arlind ?>
